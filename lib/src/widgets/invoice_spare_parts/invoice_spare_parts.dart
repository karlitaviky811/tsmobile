...
class _InvoiceSparePartState extends State<InvoiceSparePart> {
  ...
  Future<void> _submitForm() async {
    ...
    sendUpdateDataVisitPartRequestPresupuest(data, widget.visitId, imageProvider.newImagePaths);
  }
            ...
            Consumer<ImageProviderTechnicalInvoice>(
              builder: (context, imageProvider, child) {
                return ElevatedButton.icon(
                  onPressed: imageProvider.newImagePaths.isNotEmpty ? _submitForm : null,
